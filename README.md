...
This reposititory houses the PEPFAR MSD-stle training dataset to use for testing and public facing work.

You can [download the dataset](https://github.com/ICPI/TrainingDataset/raw/master/Output/MER_Structured_TRAINING_Dataset_PSNU_IM_FY17-18_20181221_v2_1.txt) or read the dataset directly into R by using the comands below. To use with R, you must have the `readr` and `ICPIutilities` package installed.
